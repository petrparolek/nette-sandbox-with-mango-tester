...
class SignPresenterTest extends TestCase
{
	...
	public function testSignInFormSentOk(Nette\Database\Explorer $ntb): void
	{
	...
	public function testSignInFormSentWithWrongPassword(Nette\Database\Explorer $ntb): void
	{
		$ntb->table('users')->insert([
			'username' => 'dave',
			'password' => password_hash('correct horse battery staple', PASSWORD_BCRYPT),
	...
	public function testSignUpFormSentWithDuplicateUsername(Nette\Database\Explorer $ntb): void
	{
		$ntb->table('users')->insert([
			'username' => 'dave',
